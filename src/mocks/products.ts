...
import StreetPerformanceWaterproof from '../assets/images/street-performance-waterproof.png'
import StreetMangaLongaWaterproof from '../assets/images/street-mangalonga-waterproof.png'
import StreetExplore from '../assets/images/street-explore.png'
import StreetCroppedExplore from '../assets/images/street-cropped-explore.png'
import StreetClassic from '../assets/images/street-classic.png'

export const products = [
    {
        id: 1,
        name: 'Camiseta Street Oversized Bold',
    ...
    {
        id: 2,
        name: 'Camiseta Street Basic Eco',
    ...
    {
        id: 4,
        name: 'Camiseta Street Regata Slip',
    ...
    {
        id: 5,
        name: 'Camiseta Street Impermeável Tech',
    ...
    {
        id: 6,
        name: 'Camiseta Street Performance Waterproof',
    ...
    {
        id: 7,
        name: 'Camiseta Street Manga Longa Waterproof',
    ...
    {
        id: 9,
        name: 'Camiseta Street Cropped Explore',
